...
set DLL_MOD_FILE_NAME=TFModFortRiseVariantCorpse.dll
set MODULE_DIR_NAME=tf-mod-fortrise-variant-corpse

set REPO_PATH=D:\__dev\code\tf-mod-fortrise-variant-corpse\
set REPO_BUILD_PATH=%REPO_PATH%VSCode\bin\Debug\net472\
set REPO_RELEASE_PATH=%REPO_PATH%release\
set REPO_RELEASE_MOD_PATH=%REPO_RELEASE_PATH%\tf-mod-fortrise-variant-corpse\
